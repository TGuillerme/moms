...
```{r custom_substest, echo = FALSE, fig.height = 10, fig.width = 8}
set.seed(42)
## Space parameters
elements <- 300
distributions <- rnorm
...
simulate.metrics <- function(elements, dimension, distributions, remove, metrics_list) {
}
...
### FUNCTION SIMULATE OUT:



### FUNCTION SUMARIZE IN:
...
### FUNCTION SUMARIZE OUT:



## Plotting the results
plot.metrics(medians, CIs, col = palette(), space = typical_removal[[1]], remove_list = typical_removal[[2]], defaults)
```
