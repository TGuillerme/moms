...
All the metrics selected were either positively correlated (Pearson correlation of 0.99 for the Average distance from centroid and Sum of variance or 0.97 for the Average nearest neighbour distance and Minimum spanning tree average length; Fig. `r figures <- figure("comparisons"); figures$print`) or somewhat correlated (ranging from 0.66 for the Sum of Variances and the Ellispsoid Volume to -0.09 between the Average displacement and the Average distance from centroid; Fig. `r figures <- figure("comparisons"); figures$print`).
...
Note however that the increase in volume does not correspond to an *actual* increase in volume in the trait-space (i.e. the volume from the blue observations in Fig. `r figures <- figure("reductions"); figures$print`B is equivalent to the one in Fig. `r figures <- figure("reductions"); figures$print`A).
