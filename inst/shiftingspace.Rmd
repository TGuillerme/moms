...
We then measured `r metric.names()` different metrics on the resulting transformed spaces, including a new metric we produced, the average displacements, which we expect to be mainly influenced by changes in trait-space position.
