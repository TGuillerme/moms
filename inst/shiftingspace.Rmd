...
|------------|--------|-----------------|---------------------|-------------|
| PCA        |500*300| Normal (mean = 0, sd = 1)| Decrease lognormally| none        |
| PCO        |500*300| Normal          | Decrease normally   | none        |
|    Normal  |500*300| Normal          | Constant            | none        |
| Normal correlated |500*300| Normal          | Constant            | Random (between 0.1 and 0.9) |
|   Uniform  |500*300| Uniform (min = 0, max = 1)| Constant            | none        |
|   Uniform  |500*300| Uniform         | Constant            | Random (between 0.1 and 0.9) |
|   Random   |500*300| Normal, Uniform, Lognormal (meanlog = 0, sdlog = 1)| Constant            | none        |
...
set.seed(42)
## Bundle simulations 
remove_05 <- simulation.bundle(remove = 0.5, replicates = 20, metrics_list = metrics_list)
remove_08 <- simulation.bundle(remove = 0.8, replicates = 20, metrics_list = metrics_list)
remove_02 <- simulation.bundle(remove = 0.8, replicates = 20, metrics_list = metrics_list)
