...
Trait space occupancy metrics can be summarised intro three main categories 
...
We analysed the effect of the different space occupancy metrics on six different studies from palaeontology, @@@GMM, and ecology to cover a broad representative view of fields using trait-spaces analysis.
...
@diaz2016 | Ecology | Plantae | Continuous data | Ordination (PCA) | @@@ |@@@ vs. @@@ | Do woody and non-woody plants occupy different parts of the plant-space?
...
* **Ecology** [@diaz2016]: 1) scaling the data and 2) ordinating the scaled data using a PCA.
...
:-----------|----------------|-----------------|----------------|---------------------|-------------------
`r name[1]` |`r plot.id(1)`  |`r plot.id(10)`   |`r plot.id(3)`  | `r s.test(1, "s")`  | `r s.test(1, "r")`
`r name[2]` |`r plot.id(2)`  |`r plot.id(11)`   |`r plot.id(6)`  | `r s.test(2, "s")`  | `r s.test(2, "r")`
`r name[3]` |`r plot.id(3)`  |`r plot.id(8)`   |`r plot.id(9)`  | `r s.test(3, "s")`  | `r s.test(3, "r")`
`r name[4]` |`r plot.id(4)` |`r plot.id(11)`  |`r plot.id(12)` | `r s.test(4, "s")`  | `r s.test(4, "r")`
`r name[5]` |`r plot.id(5)` |`r plot.id(14)`  |`r plot.id(15)` | `r s.test(5, "s")`  | `r s.test(5, "r")`
`r name[6]` |`r plot.id(6)` |`r plot.id(17)`  |`r plot.id(18)` | `r s.test(6, "s")`  | `r s.test(6, "r")`
`r name[7]` |`r plot.id(7)` |`r plot.id(20)`  |`r plot.id(21)` | `r s.test(7, "s")`  | `r s.test(7, "r")`
`r name[8]` |`r plot.id(8)` |`r plot.id(23)`  |`r plot.id(24)` | `r s.test(8, "s")`  | `r s.test(8, "r")`
`r name[9]` |`r plot.id(9)` |`r plot.id(26)`  |`r plot.id(27)` | `r s.test(9, "s")`  | `r s.test(9, "r")`
...
## List of spaces
trait_spaces <- unlist(list(palaeo, palaeo, palaeo), recursive = FALSE)
...
```{r fable_results_empirical, fig.show='hide', eval = FALSE, echo=FALSE, fig.height=1.5, fig.width=1.5}
## Making a list of parameters for each mini plot
...
## Looping through all the plots
for(dataset in 1:length(data_names)){
    for(metric in 1:length(metric_names)){
        ## Plot the results
        generate.fable.empirical(disparities[[dataset]][[metric]],
                                 disparity_t_test[[dataset]][[metric]],
                                 plot.param)
    }
}
...
```{r, echo = FALSE}
## Changing defaults
plot.id <- function(plot.ID, chain = "fable_results_empirical") {
    plot.id(plot.ID, chain = chain)
}
```

<!--

Metric      | Beck and Lee 2014 | Wright 2017 | Somebody | Somebody | Somebody | Somebody
:-----------|----------------|-----------------|----------------|-----------------|-----------------|--------------
`r name[1]` |`r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 

-->

<!--
`r name[2]` |`r plot.id(2)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[3]` |`r plot.id(3)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[4]` |`r plot.id(4)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[5]` |`r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[6]` |`r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[7]` |`r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[8]` |`r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
`r name[9]` |`r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)`  | `r plot.id(1)`  |`r plot.id(2)`   |`r plot.id(3)` 
groups | `r names(palaeo[[1]]$subsets)` | `r names(palaeo[[2]]$subsets)` | `r names(palaeo[[1]]$subsets)` | `r names(palaeo[[2]]$subsets)` | `r names(palaeo[[1]]$subsets)` | `r names(palaeo[[2]]$subsets)`
-->
