...
We selected these six space-occupancy metrics to illustrate how they capture different aspects of trait-space occupancy.
...
For each empirical trait-space we bootstrapped each group 500 times [@disprity] and applied the six space-occupancy metric to each pairs of groups.
...
:-----------|----------------|-----------------|------------------|----------------|------------------|----------------|
`r name[1]` | `r plot.id(1)` | `r plot.id(7)` | `r plot.id(13)` | `r plot.id(19)` | `r plot.id(25)` | `r plot.id(31)`|
`r name[2]` | `r plot.id(2)` | `r plot.id(8)` | `r plot.id(14)` | `r plot.id(20)` | `r plot.id(26)` | `r plot.id(32)`|
`r name[3]` | `r plot.id(3)` | `r plot.id(9)` | `r plot.id(15)` | `r plot.id(21)` | `r plot.id(27)` | `r plot.id(33)`|
`r name[4]` | `r plot.id(4)` | `r plot.id(10)` | `r plot.id(16)` | `r plot.id(22)` | `r plot.id(28)` | `r plot.id(34)`|
`r name[5]` | `r plot.id(5)` | `r plot.id(11)` | `r plot.id(17)` | `r plot.id(23)` | `r plot.id(29)` | `r plot.id(35)`|
`r name[6]` | `r plot.id(6)` | `r plot.id(12)` | `r plot.id(18)` | `r plot.id(24)` | `r plot.id(30)` | `r plot.id(36)`|
...
For all five metrics (expect the Ellispoid volume) we see either one group or the other having a bigger mean than the other.
