...
In all fields they look at the occupancy of observations in this trait space [e.g. using disparity metrics @wills2001, @hopkins2017, @disprity in evolution; or hypervolume approaches @donohue2013, @blonder2018, @mammola2019 in ecology].
...
In fact, and unsurprisingly, using different space occupancy metrics will capture different aspects of the trait-space.
...
This lack of diversity in multidimensional occupancy metrics may restrain the potential of multidimensional analysis.
...
Finally, we propose a new user friendly visual tool to build, modify and test multidimensional space occupancy metrics.
