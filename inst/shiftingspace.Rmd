...
For example, the product of range is expected to be highly sensible to the "curse of multidimensionality" [@Butler2012]: 1) first, the range of values on a dimension is bounded to the number of elements on this dimensions (i.e. the more elements on one dimension, the chance of increasing the range); 2) multiplying by 0.
...
## Measuring the effect of the metric, space, transformation and dimensionality
