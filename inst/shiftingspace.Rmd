...
## Extracting the observed space occupancies
disparity_vals <- lapply(disparities, lapply, extract.dispRity, observed = FALSE)

## Testing the differences for each distributions
disparity_t_test <- lapply(disparities, lapply, test.dispRity,
