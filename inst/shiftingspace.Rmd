...
disparity_t_test <- lapply(empirical_results, lapply, test.dispRity, test = t.test)
```
...
for(dataset in 1:length(data_names)){
    for(metric in 1:length(metric_names)){
        ## Plotting the results
        generate.fable.empirical(empirical_results[[dataset]][[metric]], disparity_t_test[[dataset]][[metric]],
...
:-----------|----------------|-----------------|------------------|----------------|------------------|----------------|
`r name[1]` | `r plot.id(1)` | `r plot.id(3)` | `r plot.id(5)` | `r plot.id(7)` | `r plot.id(9)` | `r plot.id(11)`|
`r name[2]` | `r plot.id(2)` | `r plot.id(4)` | `r plot.id(6)` | `r plot.id(8)` | `r plot.id(10)` | `r plot.id(12)`|
