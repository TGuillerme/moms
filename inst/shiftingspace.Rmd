...
Despite the commonalities between the measures used in ecology and evolution (which are often metric but don't necessarily need to be[@@@ citation?]), surprisingly little work has been published on their behaviour [but see @ciampaglio2001; @villéger2008; @mammola2019].
...
<!-- [[@@@NOTE -- I DO QUITE UNDERSTAND THIS SENTENCE, PLEASE CLARIFY]]. -->
Therefore, we propose [`moms`](https://tguillerme.shinyapps.io/moms/), a tool for researchers to design, experiment and visualise their own space occupancy measure tailored for their project.
<font style="color:blue">The tool will help researchers understand the "null" behaviour of the measures of interest.</font>
