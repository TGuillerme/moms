...
```{r fig_metrics_types, echo = FALSE, fig.height = 3, fig.width = 9, results = 'hide', fig.cap = paste("Figure 1: different type of information captured by space occupancy metrics. A - Size (e.g. sum of ranges); B - Arrangement (e.g. pairwise distances); C - Position (e.g. distances from centroid).") }
...
<font style="color:blue">Size</font> metrics measure the spread of a group in the <font style="color:blue">trait space</font>.
...
<font style="color:blue">Size</font> metrics do not take into account the distribution of the observations within a group <font style="color:blue">and can be sensible to innocupied "holes" in it [@blonder2018].</font>
...
| Ellipsoid <font style="color:blue">size</font> | $\frac{\pi^{d/2}}{\Gamma(\frac{d}{2}+1)}\displaystyle\prod_{i}^{d} (\lambda_{i}^{0.5})$ | Size | @donohue2013 | less sensitive to outliers than the convex hull hypervolume [@diaz2016; @blonder2018] |
...
<font style="color:blue">Size</font> metrics are expected to be most affected by this change.
...
Metric      | Size change  | Arrangement change | Position change | Distribution effect | Dimensions effect |
:-----------|----------------|-----------------|----------------|---------------------|-------------------|
