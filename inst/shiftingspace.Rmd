...
```{r fig_metrics_types, echo = FALSE, fig.height = 3, fig.width = 9, results = 'hide', fig.cap = paste("Figure 1: different type of information captured by space occupancy metrics. A - Size (e.g. sum of ranges); B - Density (e.g. pairwise distances); C - Position (e.g. distances from centroid).") }
...
<font style="color:blue">Density metrics measure an indication of the quantity of observations in the trait space.
...
Density is less commonly measured compared to size, but it is still used in both ecology [e.g. the minimum spanning tree length; @oksanen2007vegan] and evolution [e.g. the average pairwise distance; @geiger2008]. </font>
