---
title: "Shifting spaces: how to summarise multidimensional spaces occupancy? With moms."
...
if(length(grep("remove_05.Rda", list.files("../data/processed/"))) == 0 &&
    length(grep("rarefy_dim_05.Rda", list.files("../data/processed/"))) == 0) {
...
Study | Field | Taxonomic Group | Type of data | Trait-space | groups size | type of question
------|-------|-----------------|--------------|-------------|-------------|------------------
@beck2014 | palaeontology | Mammalia | discrete phylogenetic data | Ordination of a distance matrix (PCO) | @@@ vs. @@@ | Are crown mammals more disparate than stem mammals?
@wright2017 | palaeontology | Crinoidea | discrete phylogenetic data | Ordination of a distance matrix (PCO) | @@@ vs. @@@ | Is there a difference in disparity before and after the Ordovician mass extinction?
...
## Getting the disparity data for each chain
beck2014 <- prepare.disparity("Beck2014")
brusatte
