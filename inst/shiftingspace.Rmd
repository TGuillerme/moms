...
if(generate_data) {
    ...
    remove_02 <- simulation.spaces(remove = 0.2, replicates = 20, metrics_list = metrics_list)
...
```{r run_rarefaction, echo = FALSE, warning = FALSE, results = 'hide'}
## Toggle data generation or not
generate_data <- FALSE
...
if(generate_data) {
    ...
    ## Load results
    rarefy_05 <- load.results("rarefy_05")
    rarefy_08 <- load.results("rarefy_08")
    rarefy_02 <- load.results("rarefy_02")
}
