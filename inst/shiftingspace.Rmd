 ...
 * It has been used to answer classical questions such as 1) does disparity of one group change through time or in response to extinction or 2) do groups A and B have different disparity.
...
This type of metric measures the spread of a group in the trait-space.
...
This type of metrics measures the "packedess" of a group in the trait-space.
...
This third, more rarely used, type of metric measures the particular position of the group in the morphospace, either relative to another group or relative to a fixed point in the morphospace.
