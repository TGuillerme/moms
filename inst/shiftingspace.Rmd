...
However, the shit from a small volume (orange; Fig. `r figures <- figure("reductions"); figures$print`B) to a bigger "hollow" volume (blue; Fig. `r figures <- figure("reductions"); figures$print`B) can still be interpreted has an increase in volume.
...
Regarding the effect of dimensions and trait-space distribution, metrics seems to be either affected by neither of these factors or by both (Table `r tables <- table("simulations"); tables$print`).
