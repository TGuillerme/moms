...
<font style="color:blue">Note that the paper contains the results for only `r metric.names()` metrics which were selected as representative of common metrics covering the volume, density and position trait-space aspects.</font>
...
Second, the algorithm used to reduce the trait-spaces might not always accurately <font style="color:blue">reflect</font> changes.
