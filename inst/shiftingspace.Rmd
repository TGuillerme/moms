...
| How are they affected by space shifting?  | Space shifting            | FigX+2
| How is that reflected in the real world?  | Empirical examples        | FigX+3
...
:-----------|----------------|-----------------|------------------|----------------|------------------|----------------|
`r name[1]` | `r plot.id(1)` | `r plot.id(5)` | `r plot.id(9)` | `r plot.id(13)` | `r plot.id(17)` | `r plot.id(21)`|
`r name[2]` | `r plot.id(2)` | `r plot.id(6)` | `r plot.id(10)` | `r plot.id(14)` | `r plot.id(18)` | `r plot.id(22)`|
`r name[3]` | `r plot.id(3)` | `r plot.id(7)` | `r plot.id(11)` | `r plot.id(15)` | `r plot.id(19)` | `r plot.id(23)`|
`r name[4]` | `r plot.id(4)` | `r plot.id(8)` | `r plot.id(12)` | `r plot.id(16)` | `r plot.id(20)` | `r plot.id(24)`|
