...
In this paper, we provide the first interdisciplinary review of space occupancy metrics that uses the broad classification of metrics into volume, density and position to capture pattern changes in trait space.
