...
For example, if group A has a greater volume than group B but both have the same density, similar mechanisms could be driving both groups' space occupancy (e.g. a Brownian motion) but maybe group A is an older species and has had more time to evolve more extreme trait combinations.
