...
```{r fig_metric_correlation, echo = FALSE, fig.height = 8, fig.width = 8, results = 'hide', fig.cap = paste("Figure @@@: correlation between the scaled metrics. Numbers on the upper right corner are the Pearson correlations. The red line are linear regressions (with the confidence intervals in grey).")}
...
## Loading the results
load.results(empirical_results)
disparities <- empirical_results$disparities
disparity_t_test <- empirical_results$disparity_t_test
```
