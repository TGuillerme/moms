...
Functional dispersion | $\frac{\sqrt{\sum_{i}^{n}{({k}_{n}-Centroid_{k})^2}}{n}$ | Volume and density | Volume | @laliberté2010 | |
...
select_metrics <- list("func.disp" = func.disp,
                       ...
                       "ave.neigh"   = c(mean, neighbours),
                       "av.displa"  = c(mean, displacements),
                       "median.eig1" = function(matrix) median(abs(apply(var(matrix), 2, sum))))
```
