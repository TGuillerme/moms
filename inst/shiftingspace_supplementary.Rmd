...
The whole analysis takes approximatively @@@ times to run (single core 2.2 GHz).
...
```{r run_rarefaction_elements, echo = FALSE, warning = FALSE, results = 'hide'}
...
```{r fig_results_05_dim, echo = FALSE, fig.height = 8, fig.width = 9}
## Plotting the results for 0.5
...
```{r fig_results_08_dim, echo = FALSE, fig.height = 8, fig.width = 9}
## Plotting the results for 0.8
...
```{r fig_results_02_dim, echo = FALSE, fig.height = 8, fig.width = 10}
## Plotting the results for 0.2
