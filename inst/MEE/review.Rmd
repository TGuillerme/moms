...
*"Note that the paper contains the results for only height metrics which were selected as representative of common metrics covering the volume, density and position trait-space aspects. However, the results for the additional 17 metrics is available in the supplementary material 4."*
...
* <p style="color:blue">L332 - This makes perfect sense to me as direction in an ordination space is typically relative or would require some additional context (e.g., towards flatter/higher skulls).</p>
