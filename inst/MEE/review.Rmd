...
<!-- 
 ...
 The definition in Mitteroecker & Huttegger 2009 is specific to "morphospaces" whereas the Stadler et al 2002 one is more close to trait spaces as vaguely defined in our manuscript: 

 Mitteroecker & Huttegger 2009: "morphospace is based on the Euclidean tangent space to Kendall’s shape space, which is a Riemannian manifold" -->
