...
```{r metrics_list_simulations, echo = FALSE}
...
```{r generate_spaces_simulation, echo = FALSE, warning = FALSE, results = 'hide'}
...
```{r shift_spaces_simulation, echo = FALSE, warning = FALSE, results = 'hide'}
## Shifting each space
shift_groups <- lapply(all_spaces, lapply, shift.group.simulation, remove = 0.5)
```

```{r get_disparity_simulation, echo = FALSE, warning = FALSE, results = 'hide'}
## Measuring disparity
